...
To start and In preparation occupy full-width sections with compact production grids: four columns at ≥1400px, three at 1000–1399px, two at 600–999px, one below 600px. Counts mean dish/portion groups. Empty sections reduce to a heading/count, without an empty half-screen panel. Total quantity remains the most prominent card value.
