...
Next proposed milestone: Payments, with payment state independent of physical completion. Do not begin automatically. Later phases: Amendments, Customers, Credit, Reports, Integrations. Menu modifiers remain deferred.
